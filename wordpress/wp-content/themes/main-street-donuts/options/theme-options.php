...
Carbon_Container::factory('theme_options', __('Theme Options', 'crb'))
	->add_fields(array(
		Carbon_Field::factory('separator', 'crb_header_separator', __('Header', 'crb')),
		Carbon_Field::factory('separator', 'crb_footer_separator', __('Footer', 'crb')),
		Carbon_Field::factory('rich_text', 'crb_footer_info', __('Info Section Content', 'crb'))->help_text('The content of left big column'),
		Carbon_Field::factory('rich_text', 'crb_footer_open', __('Open Hours Section Content', 'crb')),
		Carbon_Field::factory('rich_text', 'crb_footer_contact', __('Contact Section Content', 'crb')),
		Carbon_Field::factory('rich_text', 'crb_footer_order', __('Order Section Content', 'crb'))->help_text('The content of middle column'),
		Carbon_Field::factory('text', 'crb_footer_order_link_text', __('Button Link Text', 'crb')),
		Carbon_Field::factory('text', 'crb_footer_order_link', __('Button Link', 'crb')),
		Carbon_Field::factory('map', 'crb_footer_map', __('Location', 'crb')),
